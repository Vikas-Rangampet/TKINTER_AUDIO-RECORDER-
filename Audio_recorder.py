...
voice_rec = Tk()
voice_rec.geometry("500x500")
voice_rec.title("Audio Recorder")
voice_rec.config(bg="#CC00FF")
...
title_lbl  = Label(voice_rec, text="Audio Recorder", bg="#CC00FF").grid(row=0, column=0, columnspan=3)
